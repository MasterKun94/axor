 ...
 * <p>
 * This class provides a mechanism to initialize the serialization and deserialization logic for
 * specific types of messages or actors. It is designed to be extended by concrete implementations
 * that provide the actual initialization logic.
 *
...
public abstract class ActorSystemSerdeInitializer<F extends SerdeFactory> {
    ...
    protected abstract void initialize(ActorSystem actorSystem, F serdeFactory,
