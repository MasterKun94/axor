...
package io.masterkun.axor.commons.collection;
...
/**
 * A hash map implementation of {@link ByteObjectMap} that uses open addressing for keys. To
...
public final class ByteObjectHashMap<V> implements ByteObjectMap<V> {
