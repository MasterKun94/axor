...
/**
 * Demonstrates using Transactions on an OptimisticTransactionDB with varying isolation guarantees
 */
public class OptimisticTransactionSample {
     ...
     * <p>
     * In this example, we set the snapshot multiple times.  This is probably only necessary if you
     * have very strict isolation requirements to implement.
     */
