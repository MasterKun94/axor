...
/**
 * Represents a channel for outgoing streams, extending the basic functionality of {@link StreamChannel}.
 * This interface provides a method to open a stream to a specified destination, using an event executor and an observer.
 *
...
public non-sealed interface StreamOutChannel<IN> extends StreamChannel<IN> {
     ...
     * @param to       the definition of the stream, including the address and serialization/deserialization strategy
