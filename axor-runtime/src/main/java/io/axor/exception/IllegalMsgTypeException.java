...
/**
 * Exception thrown when a message type does not match the expected type. This exception extends the
 * {@link ActorException} and is used to indicate that an operation attempted with a message of an
 * unexpected type.
 */
