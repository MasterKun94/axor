...
import io.masterkun.kactor.testkit.MessageBufferActorRef;
    ...
    public static class Node1 {
        public static void start() throws Exception {
            Config config1 = ConfigFactory
                    .load(ConfigFactory.parseString("kactor.network.bind.port = " + 10123))
                    .resolve();
    ...
    public static class Node2 {
        public static void start() throws Exception {
            Config config2 = ConfigFactory
                    .load(ConfigFactory.parseString("kactor.network.bind.port = " + 10124))
                    .resolve();
