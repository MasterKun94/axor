 ...
 *
 * This class contains static methods that create various types of assertions
 * for testing messages in actor-based systems. These assertions can be used
 * with MockActorRef to verify that the expected messages are received.
 */
public class MsgAssertions {
    ...
    /**
     * Creates an assertion that tests the message against a predicate, with a custom error message.
     *
     ...
     * @param <T> The type of messages to assert on
     * @return A message assertion that passes if the matcher returns true for the message and sender
     */
    ...
    /**
     * Creates an assertion that tests the message and sender against a matcher, with a custom error message.
     *
     * @param message The error message to use if the assertion fails
     * @param matcher The matcher to test the message and sender against
     * @param <T> The type of messages to assert on
    ...
    /**
     * Creates an assertion that tests if the message equals the expected value, with a custom error message.
     *
     * @param message The error message to use if the assertion fails
     * @param expect The expected message value
     * @param <T> The type of messages to assert on
    ...
    /**
     * Creates an assertion that tests if the message equals the expected value and the sender equals the expected sender.
     *
     * @param expect The expected message value
     * @param expectSender The expected sender
     * @param <T> The type of messages to assert on
     * @return A message assertion that passes if both the message and sender match the expected values
     */
    ...
    /**
     * Creates an assertion that tests if the message equals the expected value and the sender's address equals the expected address.
     *
     * @param expect The expected message value
     * @param expectSender The expected sender address
     * @param <T> The type of messages to assert on
     * @return A message assertion that passes if both the message and sender address match the expected values
     */
     ...
     * @param <T> The type of messages to assert on
     * @return A message assertion that passes if the message is the same instance as the expected value
     */
    ...
    /**
     * Creates an assertion that tests if the message is the same instance as the expected value
     * and the sender is the same instance as the expected sender.
     *
     * @param expect The expected message instance
     * @param expectSender The expected sender instance
     * @param <T> The type of messages to assert on
     * @return A message assertion that passes if both the message and sender are the same instances as the expected values
     */
    ...
    /**
     * Creates an assertion that tests if the message is the same instance as the expected value
     * and the sender is the same instance as the expected sender, with a custom error message.
     *
     * @param message The error message to use if the assertion fails
     * @param expect The expected message instance
     * @param expectSender The expected sender instance
    ...
    /**
     * Creates an assertion that tests if the message is the same instance as the expected value
     * and the sender's address is the same instance as the expected address.
     *
     * @param expect The expected message instance
     * @param expectSender The expected sender address instance
     * @param <T> The type of messages to assert on
     * @return A message assertion that passes if both the message and sender address are the same instances as the expected values
     */
    ...
    /**
     * Creates an assertion that tests if the message is the same instance as the expected value
     * and the sender's address is the same instance as the expected address, with a custom error message.
     *
     * @param message The error message to use if the assertion fails
     * @param expect The expected message instance
     * @param expectSender The expected sender address instance
